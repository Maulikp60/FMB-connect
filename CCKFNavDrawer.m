...
//    menuNames = [NSArray arrayWithObjects:@"Home",@"History",@"E-Credit",@"Favourite Order",@"Favourites",@"Locations",@"Exit", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImageView *image1=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 72, 72)];
    image1.image = [UIImage imageNamed:[menuImageNames objectAtIndex:indexPath.row]];
    [cell addSubview:image1];
    
    
    //cell.backgroundColor =[UIColor colorWithRed:(245.0/255.0) green:(238.0/255.0) blue:(238.0/255.0) alpha:1.0];
    return cell;
}
